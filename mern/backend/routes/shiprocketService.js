...
const SHIPROCKET_EMAIL = process.env.SHIPROCKET_EMAIL || 'your-default-email@example.com';
const SHIPROCKET_PASSWORD = process.env.SHIPROCKET_PASSWORD || 'your-default-password';

// Check if credentials are properly configured
if (SHIPROCKET_EMAIL === 'your-default-email@example.com' || SHIPROCKET_PASSWORD === 'your-default-password') {
    console.warn('⚠️ WARNING: Using default Shiprocket credentials. Set SHIPROCKET_EMAIL and SHIPROCKET_PASSWORD in your .env file');
}

const getAuthToken = async () => {
    try {
        // Log authentication attempt
        console.log(`Authenticating with Shiprocket using email: ${SHIPROCKET_EMAIL}`);
